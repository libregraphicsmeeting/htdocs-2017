...
//														@wp_mail(get_option('admin_email'), sprintf(__('[%s] New User Registration'), $blogname), $message);
														...
														if ( $number_of_talks > 1 ) {
															...
															$subject = 'Your '.$number_of_talks.' proposals for LGM2017 have been accepted';
														
														} else if ( $number_of_talks == 1 ) {
															
															$message .= "proposal – ".$the_talk_title." – has been accepted";
															
															$subject = 'Your proposal for LGM2017 – '.$the_talk_title.' – has been accepted';
